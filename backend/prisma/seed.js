...
async function main() {
    ...
    const Activity2 = await prisma.activity.create({
        data: {
            ...
            maxPeople: 10,
            price: 50,
            time:['09.00-10.00','10.00-11.00','11.00-12.00','12.00-13.00','13.00-14.00','14.00-15.00','15.00-16.00','16.00-17.00','17.00-18.00','18.00-19.00','19.00-20.00','20.00-21.00']
        },
    });
    ...
    const Activity4 = await prisma.activity.create({
        data: {
            ...
            maxPeople: 4,
            price: 50,
            time:['09.00-10.00','10.00-11.00','11.00-12.00','12.00-13.00','13.00-14.00','14.00-15.00','15.00-16.00','16.00-17.00','17.00-18.00','18.00-19.00']
        },
    });
    ...
    const Activity5 = await prisma.activity.create({
        data: {
            ...
            maxPeople: 6,
            price: 100,
            time:['09.00-10.00','10.00-11.00','11.00-12.00','12.00-13.00','13.00-14.00','14.00-15.00','15.00-16.00','16.00-17.00','17.00-18.00']
        },
    });
    ...
    const Activity6 = await prisma.activity.create({
        data: {
            ...
            maxPeople: 6,
            price: 100,
            time:['09.00-10.00','10.00-11.00','14.00-15.00','15.00-16.00','16.00-17.00']
        },
    });
